  ...
  <section id="projects" class="row collapse">
	...
	<div class="column small-6 project" style="background-color: <?php the_field('image_background_color') ?> ">
...
<?php $post = get_field("featured2", $page_id); setup_postdata( $post ); ?>
	<div class="column small-6 project">
		<div class="margin-left project-bottom project-small" style="background-color: <?php the_field('image_background_color') ?> ">
			<div class="hide-for-medium-down title-right"><a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>" rel="bookmark"><?php the_field("category_short"); ?></a></div>
		<div class="show-for-medium-down title-left"><a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>" rel="bookmark"><?php the_field("category_short"); ?></a></div>
...
<?php $post = get_field("featured3", $page_id); setup_postdata( $post ); ?>
	<div class="column small-6 project text-right">
		<div class="margin-right project-right project-small" style="background-color: <?php the_field('image_background_color') ?> ">
			<div class="hide-for-medium-down title-left"><a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>" rel="bookmark"><?php the_field("category_short"); ?></a></div>
		<div class="show-for-medium-down title-right"><a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>" rel="bookmark"><?php the_field("category_short"); ?></a></div>
...
<?php $post = get_field("featured4", $page_id); setup_postdata( $post ); ?>
	<div class="column small-6 project" style="background-color: <?php the_field('image_background_color') ?> ">
	<div class="hide-for-medium-down title-left-down"><a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>" rel="bookmark"><?php the_field("category_short"); ?></a></div>
	<div class="show-for-medium-down title-left"><a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>" rel="bookmark"><?php the_field("category_short"); ?></a></div>
